...
namespace MainSite.News
{
    ...
    public class NewsController : Controller
    {
        ...
        [HttpGet]
        [ProducesResponseType(typeof(List<News_Entity>), 200)]
        ...
        /// <response code="404">Ничего нет.</response>
        [HttpGet("{id}")]
        [ProducesResponseType(typeof(News_Entity), 200)]
        [ProducesResponseType(404)]
        ...
        [HttpPost("{id}")]
        [ProducesResponseType(typeof(News_Entity), 202)]
        [ProducesResponseType(400)]
        [ProducesResponseType(404)]
